...
Task sources allow importing tasks from external systems (Linear, Jira, Notion, etc.) via MCP servers. Each task source is linked to an MCP server and uses its tools to list and update tasks.
