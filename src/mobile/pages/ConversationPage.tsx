      ...
      <div className="relative flex-1 min-h-0">
        ...
        {showScrollToBottom && messages.length > 0 && (
          <button
            ...
            className="absolute bottom-3 right-3 flex items-center gap-1.5 rounded-full bg-card border border-border/50 px-3 py-1.5 text-xs text-muted-foreground hover:text-foreground hover:border-border shadow-lg transition-[color,border-color,opacity] duration-200 opacity-80 hover:opacity-100 active:opacity-100"
