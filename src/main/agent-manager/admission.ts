 ...
 * not, the start waits in a FIFO {@link SessionAdmission} in the main process and is
...
function isExemptFromAdmission(taskId: string, task: TaskRecord | undefined | null): boolean {
...
function parseGlobalSessionLimit(raw: string | null | undefined): number | null {
