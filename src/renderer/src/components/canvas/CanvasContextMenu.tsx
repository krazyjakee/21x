...
import { CheckSquare, MessageSquare, Globe, TerminalSquare, Plus, X, Square, Circle, Minus, MoveUpRight, Type, Image } from 'lucide-react'
...
export function CanvasContextMenu({ position, onClose }: CanvasContextMenuProps) {
  ...
  return (
    <div
      ref={menuRef}
      className="fixed z-[9999] min-w-[220px] max-w-[280px] bg-popover border border-border/50 rounded-xl shadow-float overflow-hidden animate-in fade-in zoom-in-95 duration-100"
